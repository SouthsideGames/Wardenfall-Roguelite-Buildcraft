...
namespace SouthsideGames.Mineral
{
    ...
    public static class ColoredFoldersEditor
    {
        ...
        private static void StoreIconGuids()
        {
            ...
            // We should first look for the Southside Games folder
            string southsideGamesFolderPath = MineralEditor.FindFolderByName("Southside Games");

            if(southsideGamesFolderPath == null || southsideGamesFolderPath == "")
            {
                Debug.LogError("Mineral : No Southside Games folder found...");
                return;
            }

            iconsPath = southsideGamesFolderPath + "/" + Constants.localColoredIconsPath; 
